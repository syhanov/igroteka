...
Обложки карточек игр являются объектами авторского права соответствующих правообладателей.
Все изображения обложек получены с IGDB.com из раздела "Media → Localized Covers" и используются исключительно в демонстрационных/образовательных целях.
...
Все обложки получены с **IGDB.com** из раздела **Media → Localized Covers**.

Изображение DualSense для интро сгенерировано мной и не относится к изображениям, полученным с IGDB.

Обложки игр являются интеллектуальной собственностью соответствующих правообладателей и используется в проекте только для идентификации игр. Все права на изображения принадлежат их законным владельцам.